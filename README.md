...
- admin: username `admin`, password `SweetLab@2026!`
...
- **Visualización:** Cualquiera puede ver las imágenes que se incluyen en `frontend/src/assets` y las imágenes asociadas a cada receta desde la interfaz pública.
